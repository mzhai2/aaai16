function [clusterIndices,purity] = plotKmeans(mappedX2,foundWords,foundCategories,kernelMethod,vectors,numCategories,vocab2cat,distance,subscript,showWindows,visible)

opts = statset('Display','final','UseParallel',true);
[clusterIndices, centers] = kmeans(vectors,numCategories,'Distance',distance,'Replicates',3,'Options',opts);
global ind;
